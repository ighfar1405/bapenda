...
<body>
    ...
    <div class="main-content" id="panel">
        ...
        <!-- Header -->
        <!-- Header -->
        <div class="header bg-red pb-6 mb-20" style="height:300px;font-size:3.5em;color:#ffffff;">
        ...
        <div class="text-center mt-5">
            <button class="btn btn-secondary"><a class="nav-link"  href="{{ route('login') }}">Go To Dashboard<span class="sr-only">(current)</span></a></button>
        </div>
