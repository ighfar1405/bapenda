...
@section('title', 'Pemidahan Pemakaian Baru')
    ...
    <div class="col">
        ...
        <div class="card pb-4">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('pemindahan_pemakaian.store') }}" method="post" autocomplete="off">
                    @csrf
                    @method('POST')
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control bg-white" name="objek_retribusi" id="objek-retribusi"
                            placeholder="Objek Retribusi" value="{{ old('objek_retribusi') }}" readonly>
                        <input type="hidden" name="objek_retribusi_id" id="id_objek" value="{{ old('objek_retribusi_id') }}">
                    </div>
                    <hr>
                    <div class="d-flex flex-lg-row">
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="text" class="form-control" name="kelurahan-info" id="kelurahan-info"
                                value="{{ old('kelurahan-info') }}" readonly>
                        </div>
                        <div class="form-group col-4 pr-lg-0">
                            ...
                            <input type="text" class="form-control" name="total_tarif" id="total"
                                value="{{ old('total_tarif') }}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="pemakai_lama">Pemakai Lama</label>
                        <input type="text" class="form-control" name="pemakai_lama" id="pemakai_lama"
                            value="{{ old('pemakai_lama') }}" readonly>
                        <input type="hidden" name="pemakai_lama_id" id="pemakai_lama_id" value="{{ old('pemakai_lama_id') }}">
                    </div>
                    <hr>
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="pemakai_baru" id="pemakai_baru">
                            ...
                            <option value="{{ $item->id }}" {{ old('pemakai_baru')==$item->id ? 'selected' : '' }}>
                                {{ $item->nama }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="klasifikasi_pemakaian_id" id="klasifikasi_pemakaian_id">
                        ...
                        @foreach ($klasifikasi as $item)
                            <option value="{{ $item->id }}" {{ $item->id == old('klasifikasi_pemakaian_id') ? 'selected' : '' }}>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tanggal_sk" id="tanggalSK"
                            placeholder="Tanggal SK" value="{{ old('tanggal_sk') }}">
                    </div>
