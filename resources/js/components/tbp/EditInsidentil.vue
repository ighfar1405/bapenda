      ...
      <div class="col-md-8">
        <div class="pl-lg-4">
          <div class="form-group">
            ...
            <textarea name="alamat_objek" class="form-control" cols="30" rows="3" v-model="alamat_objek"></textarea>
          </div>
        </div>
      </div>
    </div>
...
export default {
  ...
  async created () {
    try {
      // set init data
      this.no_surat_izin = this.tbp.no_surat_izin
      this.tanggal_izin = this.tbp.tanggal_izin
      this.pemakai = this.tbp.pemakai
      this.nama_objek = this.tbp.nama_objek
      this.alamat_objek = this.tbp.alamat_objek
      this.tarif = this.tbp.tarif
      this.luas = this.tbp.luas
      this.tinggi = this.tbp.tinggi
