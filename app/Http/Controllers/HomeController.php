...
// return $piutangPerKecamatan;
        return view('landing-hero', compact('totalKlasifikasi', 'nominalPiutang', 'totalNominalTbp', 'tahun', 'yearActive','data1','data2', 'penerimaanPerKecamatan','piutangPerKecamatan'));
    }
